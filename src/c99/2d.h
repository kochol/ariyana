...
CARI_API void AddCamera2dToWorld(void* _world, EntityHandle* _entity, Node2dHandle* _camera);
CARI_API void RemoveCamera2dFromWorld(void* _world, EntityHandle* _entity, Node2dHandle* _camera, bool _dispose);
...
CARI_API void AddSprite2dToWorld(void* _world, EntityHandle* _entity, Node2dHandle* _node);
CARI_API void RemoveSprite2dFromWorld(void* _world, EntityHandle* _entity, Node2dHandle* _node, bool _dispose);
