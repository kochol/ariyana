...
namespace ari
{
	namespace core
	{
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		KeyValuePair<KEY, VALUE>::KeyValuePair(const KEY& k, const VALUE& v) : key(k),
			value(v)
		{
			// empty
		}
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		KeyValuePair<KEY, VALUE>::KeyValuePair(KEY&& k, VALUE&& v) : key(std::move(k)),
			value(std::move(v))
		{
			// empty
		}
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		KeyValuePair<KEY, VALUE>::KeyValuePair(const KeyValuePair& rhs) : key(rhs.key),
			value(rhs.value)
		{
			// empty
		}
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		void KeyValuePair<KEY, VALUE>::operator=(const KeyValuePair& rhs)
		{
			if (&rhs != this)
			{
				this->key = rhs.key;
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		void KeyValuePair<KEY, VALUE>::operator=(KeyValuePair&& rhs)
		{
			if (&rhs != this)
			{
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		bool KeyValuePair<KEY, VALUE>::operator==(const KeyValuePair& rhs) const
		{
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		inline bool operator==(const KeyValuePair<KEY, VALUE>& kvp, const KEY& key)
		{
			return kvp.key == key;
		};
		...
		//------------------------------------------------------------------------------
		template <class KEY, class VALUE>
		inline bool operator==(const KEY& key, const KeyValuePair<KEY, VALUE>& kvp)
		{
			return key == kvp.key;
		};
